    ...
    function GLTFMaterialsPbrSpecularGlossinessExtension() {
      ...
      return {
        ...
        createMaterial: function(params) {
          ...
          material.map = params.map === undefined
            ? null
            : params.map;
          ...
          material.aoMap = params.aoMap === undefined
            ? null
            : params.aoMap;
          ...
          material.envMap = params.envMap === undefined
            ? null
            : params.envMap;
        ...
        refreshUniforms: function(renderer, scene, camera, geometry, material, group) {
          ...
          uniforms.flipEnvMap.value = (material.envMap && material.envMap.isCubeTexture)
            ? - 1
            : 1;
      ...
      return this.getDependencies('accessor').then(function(accessors) {
        ...
        for (var i = 0, il = primitives.length; i < il; i++) {
          ...
          if (cached) {
            ...
            // Cache this geometry
            cache.push({primitive: primitive, promise: Promise.resolve(geometry)});
